...
function updateMetrics() {
 ...
 //console.log(words)
 wordCountElement.innerHTML = `Palabras: ${words}`;
...
//Evento input en el textArea y actualización de métricas en timepo real
...
resetBtn.addEventListener('click', function(){
 ...
 charCountElement.innerHTML = `Caracteres: 0`
 charCountNoSpacesElement.innerHTML = `Caracteres sin espacios ni signos de puntuación: 0`
 numbersCountElement.innerHTML = `Números: 0`
 numberSumElement.innerHTML = `Suma de números: 0`
 averageWordLengthElement.innerHTML = `Longitud promedio de palabras: 0`
})
